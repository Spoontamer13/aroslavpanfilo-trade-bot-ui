            ...
            try:
                while not self._stop_requested:
                    ...
                    if candle:
                        ...
                        # Сигналы стратегии
                        # Эмитим текущее проскальзывание из настроек (проценты)
                        sl = bot.settings.get("global", {}).get("slippage_percent", 0.0)
                        # сигнал ожидает дробное процентное значение (например 0.05 → 0.05)
